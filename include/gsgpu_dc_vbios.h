...
struct vbios_funcs {
	...
	bool (*create_backlight_resource)(struct gsgpu_vbios *vbios, void *data, u32 link, u32 size);
	...
	struct backlight_resource *(*get_backlight_resource)(struct gsgpu_vbios *vbios, u32 link);
};
