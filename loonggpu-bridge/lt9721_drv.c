...
static bool lt9721_chip_id_verify(struct loonggpu_bridge_phy *phy, char *str)
{
...
static enum hpd_status lt9721_get_hpd_status(struct loonggpu_bridge_phy *phy)
{
	u32 val;
...
int lt9721_hdmi_rx_cdr(struct loonggpu_bridge_phy *phy)
{
...
int lt9721_rx_pll(struct loonggpu_bridge_phy *phy)
{
...
static int lt9721_tx_phy(struct loonggpu_bridge_phy *phy)
{
...
static int lt9721_tx_pll_cfg(struct loonggpu_bridge_phy *phy)
{
...
int lt9721_hdmi_format(struct loonggpu_bridge_phy *phy)
{
...
static int lt9721_bl_ctrl(struct loonggpu_bridge_phy *phy, int mode)
{
...
static int lt9721_mode_set(struct loonggpu_bridge_phy *phy,
...
static int lt9721_video_input_cfg(struct loonggpu_bridge_phy *phy)
{
	lt9721_tx_phy(phy);
...
static int lt9721_video_output_cfg(struct loonggpu_bridge_phy *phy)
{
...
{
	struct loonggpu_bridge_phy *lt9721_phy;
	struct lt9721_device *lt9721_dev;

	lt9721_phy = bridge_phy_alloc(res);

	lt9721_phy->cfg_funcs = &lt9721_cfg_funcs;
	lt9721_phy->regmap_cfg = &lt9721_regmap_config;
	lt9721_phy->misc_funcs = &lt9721_misc_funcs;
	lt9721_phy->hpd_funcs = &lt9721_hpd_funcs;
	lt9721_phy->is_ext_encoder = true;
